...
try:
    ...
    st.error("Make sure auth.py and app2.py are in the same directory as this streamlit_app.py file")
    st.stop()
...
def main():
    st.set_page_config(
        page_title="Business Intelligence Analyzer - Prolexis Analytics",
        page_icon="📊",
        layout="wide"
    )

    st.title("📊 Business Intelligence Analyzer")
    st.markdown("**Prolexis Analytics** - Advanced AI-powered business analysis and trend identification")
    ...
    st.markdown(
        ...
        <div style='text-align: center; color: gray;'>
            <p>Business Intelligence Analyzer | Powered by Claude AI on AWS Bedrock | 
            <a href='/' style='color: gray;'>← Back to Prolexis Analytics</a></p>
        </div>
        """, 
        unsafe_allow_html=True
    )
